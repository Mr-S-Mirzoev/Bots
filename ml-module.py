    ...
    def recommend_items(self, user_id, items_to_ignore=[], topn=10, verbose=False):
        ...
        if verbose:
            ...
            recommendations_df = recommendations_df.merge(self.items_df, how = 'left', 
                                                          left_on = 'contentId', 
                                                          right_on = 'contentId')[['eventStrength', 'contentId', 'title', 'link']]
...
class ContentBasedRecommender:
    ...
    def recommend_items(self, user_id, items_to_ignore=[], topn=10, verbose=False):
        ...
        if verbose:
            ...
            recommendations_df = recommendations_df.merge(self.items_df, how = 'left', 
                                                          left_on = 'contentId', 
                                                          right_on = 'contentId')[['recStrength', 'contentId', 'title', 'link']]
...
class HybridRecommender:
    ...
    def recommend_items(self, user_id, items_to_ignore=[], topn=10, verbose=False):
        ...
        if verbose:
            ...
            recommendations_df = recommendations_df.merge(self.items_df, how = 'left', 
                                                          left_on = 'contentId', 
                                                          right_on = 'contentId')[['recStrengthHybrid', 'contentId', 'title', 'link']]
...
"""
shows user interactions sorted by eventStrength
"""
